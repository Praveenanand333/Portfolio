...
function Education() {
  ...
  const educationData = [
    ...
    },
    {
      ...
      logo: '/Portfolio/images/jaycee-logo.png',
      /* CUSTOM-DONE: Add your institution logos to the /public/images folder and update this path to "/Portfolio/images/jaycee-logo.jpg" or similar */
    },
  ];
